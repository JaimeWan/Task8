...
public class EmailUtil implements EmailService {
    public String convert(List<Email> dataList) {
    ...
    public String send_template(String address, String username, int vcode) throws ClientProtocolException, IOException {
